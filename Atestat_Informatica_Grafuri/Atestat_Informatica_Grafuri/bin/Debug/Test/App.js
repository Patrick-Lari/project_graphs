...
function getResult(element){
	...
	if (id === currentQuestion.answer){
		...
		//if the answer is incorrect, show the correct option by adding green color into the correct option
...
//make all the options unclickable once the user selected a option
...
function startQuiz() {
	...
	//first we will set all the questions in availableQuestions Array
